...
#     Boolean which describes whether the device supports Wi-Fi to Cellular.
{
    ...
    GET_BUILD_VAR "TARGET_LCD_CONFIG_SUB_HFR_MODE" "none"
    ...
    GET_BUILD_VAR "TARGET_LCD_CONFIG_SUB_HFR_SUPPORTED_REFRESH_RATE" "$(test "$TARGET_LCD_CONFIG_SUB_HFR_MODE" -gt "0" && echo "" || echo "none")"
